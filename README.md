...
* Create an instance of the Azure SQL DB service by name specified in manifest.yml. If you want to use a different DB service, make sure you have the corresponding DB driver dependency added to the pom.xml
